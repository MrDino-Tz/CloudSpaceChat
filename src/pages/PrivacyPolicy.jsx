    ...
    <div className="auth-root" style={{ overflowY: 'auto' }}>
      <div className="auth-container" style={{ padding: '40px 16px', minHeight: '100vh', justifyContent: 'flex-start' }}>
        ...
        <div className="auth-card" style={{ maxWidth: '800px', backgroundColor: '#fff', padding: '32px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
          <h1 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '16px', color: '#111827' }}>Privacy Policy</h1>
          ...
          <div style={{ color: '#374151', lineHeight: '1.6', fontSize: '15px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <p>At CloudSpace, we value your privacy. This policy outlines how we collect, use, and protect your personal information.</p>
            
            <h2 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginTop: '16px' }}>1. Information We Collect</h2>
            ...
            <h2 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginTop: '16px' }}>2. How We Use Information</h2>
            <p>Your information is used strictly to provide, maintain, and improve the CloudSpace service. This includes authenticating your account, delivering messages, and notifying you of platform updates.</p>

            <h2 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginTop: '16px' }}>3. Data Security</h2>
            ...
            <h2 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginTop: '16px' }}>4. Link Security Scanning</h2>
            <p>To protect our users from malicious websites, CloudSpace includes an automatic Link Security Scanning feature. This feature evaluates URLs shared in messages using client-side heuristics (such as checking for trusted domains, HTTPS encryption, and suspicious patterns).</p>
            ...
            <h2 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginTop: '16px' }}>5. Data Sharing</h2>
            ...
            <h2 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginTop: '16px' }}>6. Your Rights</h2>
