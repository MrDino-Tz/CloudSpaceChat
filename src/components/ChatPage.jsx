...
const FILE_EXT_COLORS = {
  ...
  xml: { bg: "#dbeafe", color: "#2563eb" },
  json: { bg: "#fef3c7", color: "#b45309" },
  md: { bg: "#f3f4f6", color: "#374151" },
  apk: { bg: "#dcfce7", color: "#16a34a" },
  exe: { bg: "#e2e8f0", color: "#334155" },
  msi: { bg: "#e2e8f0", color: "#334155" },
  bat: { bg: "#e2e8f0", color: "#334155" },
  sh: { bg: "#e2e8f0", color: "#334155" },
  ...
  html: { bg: "#ffedd5", color: "#ea580c" },
  css: { bg: "#e0e7ff", color: "#4f46e5" },
  java: { bg: "#fee2e2", color: "#dc2626" },
  cpp: { bg: "#e0e7ff", color: "#4f46e5" },
  psd: { bg: "#dbeafe", color: "#1d4ed8" },
  ai: { bg: "#ffe4d6", color: "#b45309" },
};
        ...
        <div className="attach-wrapper" ref={menuRef}>
          ...
          {menuOpen && (
            <div className="attach-menu">
              ...
              <div className="attach-menu-item" onClick={() => handleAttach(".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.zip,.rar,.apk,.exe,.msi,.bat,.sh,.mp3,.wav,.ogg,.m4a,.js,.ts,.py,.html,.css,.json,.java,.cpp,.csv,.xml,.md,.psd,.ai", "file")}>
