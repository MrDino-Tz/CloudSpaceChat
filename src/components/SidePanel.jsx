...
const FILE_ICONS = {
  ...
  xml: { color: "#3b82f6", label: "XML" },
  json: { color: "#b45309", label: "JSON" },
  md: { color: "#374151", label: "MD" },
  apk: { color: "#16a34a", label: "APK" },
  exe: { color: "#334155", label: "EXE" },
  msi: { color: "#334155", label: "MSI" },
  bat: { color: "#334155", label: "BAT" },
  sh: { color: "#334155", label: "SH" },
  mp3: { color: "#db2777", label: "MP3" },
  ...
  css: { color: "#4f46e5", label: "CSS" },
  java: { color: "#dc2626", label: "JAVA" },
  cpp: { color: "#4f46e5", label: "CPP" },
  psd: { color: "#1d4ed8", label: "PSD" },
  ai: { color: "#b45309", label: "AI" },
};
